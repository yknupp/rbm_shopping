...
<body>
    <h1 class="my-5">Olá, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. Bem vindo ao Independência Shopping.</h1>
    <p>Para cadastrar um cupom, preencha o formulário abaixo.</p>
    <div class="wrapper">
